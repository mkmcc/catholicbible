...
(defconst catholicbible--knox-books
  '(("Genesis"         . (:name "Genesis"          :url-path "/OT/Gen"   :chaps 50))
    ...
    ("1 Samuel"        . (:name "1 Kings"          :url-path "/OT/3_Kgs" :chaps 22))
    ("2 Samuel"        . (:name "2 Kings"          :url-path "/OT/4_Kgs" :chaps 25))
    ...
    ("Isaiah"          . (:name "Isaias"           :url-path "/OT/Isa"   :chaps 51))
    ("Jeremiah"        . (:name "Jeremias"         :url-path "/OT/Jer"   :chaps 51))
...
(defconst catholicbible--vulgate-books
  '(("Genesis"         . (:name "Genesis"             :url-path "/OT/Gn"    :chaps 50))
    ...
    ("Isaiah"          . (:name "Isaias"              :url-path "/OT/Is"    :chaps 51))
    ("Jeremiah"        . (:name "Jeremias"            :url-path "/OT/Jr"    :chaps 51))
